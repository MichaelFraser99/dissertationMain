...
function addNewInfrastructure() {
    ...
    if (nameField.value != "") {
        window.location.href ="./allInfrastructure?mode=addInfrastructure&name=" + nameField.value + "&category=" + categoryField.value + "&description=" + infrastructureDescriptionField.value + "&group=" + groupField.value + "&extraData=" + extraData + "&extraDataDataTypes=" + extraDataDataType;
    } else {
...
function deleteInfrastructure() {
    ...
    confirmationURL.textContent = "./allInfrastructure?mode=deleteInfrastructure&id=" + infrastructureID;
...
function infrastructureClick(clickedId) {
    window.location.href = "./infrastructureInformation";
}

function passwordClick(clickedId) {
    window.location.href = "./accountInformation?id=" + clickedId;
}

function editAccessClick(clickedId) {
    window.location.href = "./editAccessRights";
}

function backToInfrastructure() {
    window.location.href = "/allInfrastructure";
}
...
function backToAccess() {
    window.location.href = "./accessRights";
}

function editInfrastructure() {
    infrastructureID = document.getElementById("infrastructureID").textContent;
    window.location.href = "/addItem?mode=editInfrastructure&id=" + infrastructureID;
}

function cancelInfrastructureEdit() {
    infrastructureID = document.getElementById('infrastructureID').textContent;
    window.location.href = "/infrastructureInformation?infrastructureID=" + infrastructureID;
}
...
function updateInfrastructure() {
    ...
    window.location.href = "/infrastructureInformation?mode=updateInfrastructure&infrastructureID=" + infrastructureID + "&name=" + infrastructureName + "&category=" + infrastructureCategory + "&description=" + infrastructureDescription + "&group=" + infrastructureGroup + "&extraData=" + extraData + "&extraDataDataTypes=" + extraDataDataType; 
}
...
function addNewGroup() {
    ...
    if (groupName != "" && groupDescription != "") {
        window.location.href ="./allGroups?mode=addGroup&name=" + groupName + "&description=" + groupDescription;
    } else {
...
function editGroup() {
    ...
    window.location.href = "/addGroup?mode=editGroup&id=" + groupID;
}
...
function deleteGroup() {
    ...
    confirmationURL.textContent = "./allGroups?mode=deleteGroup&id=" + groupID;
...
function cancelGroupEdit() {
    groupID = document.getElementById('groupID').textContent;
    window.location.href = "/manageGroup?groupID=" + groupID;
}
...
function updateGroups() {
    ...
    window.location.href = "/manageGroup?mode=updateGroup&groupID=" + groupID + "&name=" + groupName + "&description=" + groupDescription; 
}
...
function addNewCategory() {
    ...
    if (categoryName != "" && categoryDescription != "") {
        window.location.href ="./allCategories?mode=addCategory&name=" + categoryName + "&description=" + categoryDescription;
    } else {
        displayError("Please ensure you have entered a name and description");
    }
}
...
function editCategory() {
    ...
    window.location.href = "/addCategory?mode=editCategory&id=" + categoryID;
}
...
function deleteCategory() {
    ...
    confirmationURL.textContent = "./allCategories?mode=deleteCategory&id=" + categoryID;
...
function cancelCategoryEdit() {
    categoryID = document.getElementById('categoryID').textContent;
    window.location.href = "/manageCategory?categoryID=" + categoryID;
}
...
function updateCategory() {
    ...
    window.location.href = "/manageCategory?mode=updateCategory&categoryID=" + categoryID + "&name=" + categoryName + "&description=" + categoryDescription;
}
...
function midAddCategory() {
    ...
    window.location.href = "/addCategory?mode=midAdd&priorLocation=" + priorLocation + "&previous=" + id;
}
...
function midAddGroup() {
    ...
    window.location.href = "/addGroup?mode=midAdd&priorLocation=" + priorLocation + "&previous=" + id;
}
...
function quickCancel() {
    ...
    if (window.location.href.includes("priorLocation=\"edit\"")) {
        window.location.href = "/addItem?mode=editInfrastructure&id=" + id;
    } else {
...
function quickCategoryFinish() {
    ...
    if (categoryName != "" && categoryDescription != "") {
        window.location.href ="./allCategories?mode=addCategoryAndReturn&priorLocation=" + priorLocation + "&previous=" + id + "&name=" + categoryName + "&description=" + categoryDescription;
    } else {
        displayError("Please ensure you have entered a name and description");
    }
}
...
function quickGroupFinish() {
    ...
    if (groupName != "" && groupDescription != "") {
        window.location.href ="./allGroups?mode=addGroupAndReturn&priorLocation=" + priorLocation + "&previous=" + id + "&name=" + groupName + "&description=" + groupDescription;
    } else {
        displayError("Please ensure you have entered a name and description");
    }
}
...
function addToGroup(id) {
    groupId = document.getElementById("groupID").textContent;
    window.location.href = "./manageGroup?groupID=" + groupId + "&mode=add&itemID=" + id;
}

function removeFromGroup(id) {
    groupId = document.getElementById("groupID").textContent;
    window.location.href = "./manageGroup?groupID=" + groupId + "&mode=remove&itemID=" + id;
}
...
function addNewAccount() {
    ...
    if (accountName != "" && username != "" && password != "" && description != "") {
        window.location.href = "./passwords?mode=addAccount&username=" + username + "&password=" + password + "&description=" + description + "&name=" + accountName;
    } else {
...
function editAccount() {
    ...
    window.location.href = "./addAccount?mode=edit&id=" + accountID;
}

function cancelAccountEdit() {
    accountID = document.getElementById('accountID').textContent;
    window.location.href = "/accountInformation?id=" + accountID;
}
...
function updateAccount() {
    ...
    window.location.href = "/accountInformation?mode=update&id=" + accountID + "&name=" + accountName + "&username=" + accountUsername + "&password=" + accountPassword + "&description=" + accountDescription;
}
...
function deleteAccount() {
    ...
    confirmationURL.textContent = "./passwords?mode=delete&id=" + accountID;
...
function attachFile() {
    ...
    greyOut.style["visibility"] = "visible";
    fileUploadBox.style["visibility"] = "visible";
}
...
function deleteFile(id) {
    ...
    window.location.href = "/addItem?mode=editInfrastructure&id=" + infrastructureID + "&deleteFile=" + id;
}
...
function cancelFileUpload() {
    ...
    greyOut.style["visibility"] = "hidden";
    fileUploadBox.style["visibility"] = "hidden";
}

function addAccess() {
    accessName = document.getElementById("accessLevelName").value;
    mInfrastructure = document.getElementById("1").checked;
    mGroup = document.getElementById("2").checked;
    mCategory = document.getElementById("3").checked;
    mPassword = document.getElementById("4").checked;
    mUser = document.getElementById("5").checked;
    vInfrastructure = document.getElementById("6").checked;
    vGroup = document.getElementById("7").checked;
    vCategory = document.getElementById("8").checked;
    vPassword = document.getElementById("9").checked;
    vUser = document.getElementById("10").checked;

    window.location.href = "./accessRights?mode=addAccessLevel&name=" + accessName + "&mInfrastructure=" + mInfrastructure + "&mGroup=" + mGroup + "&mCategory=" + mCategory + "&mPassword=" + mPassword + "&mUser=" + mUser + "&vInfrastructure=" + vInfrastructure + "&vGroup=" + vGroup + "&vCategory=" + vCategory + "&vPassword=" + vPassword + "&vUser=" + vUser;
}

function saveAccess() {
    accessID = document.getElementById("accessLevelID").textContent;
    accessName = document.getElementById("accessLevelName").value;
    mInfrastructure = document.getElementById("1").checked;
    mGroup = document.getElementById("2").checked;
    mCategory = document.getElementById("3").checked;
    ...
    window.location.href = "./accessRights?mode=updateAccessLevel&id=" + accessID + "&name=" + accessName + "&mInfrastructure=" + mInfrastructure + "&mGroup=" + mGroup + "&mCategory=" + mCategory + "&mPassword=" + mPassword + "&mUser=" + mUser + "&vInfrastructure=" + vInfrastructure + "&vGroup=" + vGroup + "&vCategory=" + vCategory + "&vPassword=" + vPassword + "&vUser=" + vUser;
} 

function deleteAccess() {
    accessID = document.getElementById("accessLevelID").textContent;
    window.location.href = "./accessRights?mode=deleteAccessLevel&id=" + accessID;
}

function addUser() {
    userEmail = document.getElementById("userEmail").value;
    selectedAccessIndex = document.getElementById("infrastructureGroupField").selectedIndex;
    selectedAccessID = document.getElementById("infrastructureGroupField")[selectedAccessIndex].id;

    window.location.href = "./userManagement?mode=addUser&email=" + userEmail + "&accessID=" + selectedAccessID;
}
...
function deleteUser(id) {
    window.location.href = "./userManagement?mode=deleteUser&id=" + id;
}
...
function pageSetup() {
    ...
    accessAddButton = document.getElementById("accessAddButton");
    accessSaveButton = document.getElementById("accessSaveButton");
    accessDeleteButton = document.getElementById("accessDeleteButton");
    ...
    fileRowOpenButtons = document.getElementsByClassName("fileRowOpenButton");
    fileRowDeleteButtons = document.getElementsByClassName("fileRowDeleteButton");
    fileUploadCancelButton = document.getElementById("fileUploadCancelButton");
    addUserBackButton = document.getElementById("addUserBackButton");
    addUserAddButton = document.getElementById("addUserAddButton");
    userDeleteButtons = document.getElementsByClassName("userDelete");
    ...
    for (var i = 0; i < userDeleteButtons.length; i++) {
        userDeleteButtons[i].addEventListener("click", function(){deleteUser(this.id)});
    }

    for (var i = 0; i < fileRowOpenButtons.length; i++) {
        fileRowOpenButtons[i].addEventListener("click", function(){openFile(this.id)});
    }

    for (var i = 0; i < fileRowDeleteButtons.length; i++) {
        fileRowDeleteButtons[i].addEventListener("click", function(){deleteFile(this.id)});
    }
    ...
    if (addUserAddButton != null) {
        addUserAddButton.addEventListener("click", function(){addUser()});
    }

    if (addUserBackButton != null) {
        addUserBackButton.addEventListener("click", function(){backToUsers()});
    }

    if (fileUploadCancelButton != null) {
        fileUploadCancelButton.addEventListener("click", function(){cancelFileUpload()});
    }

    if (attachFileButton != null) {
        attachFileButton.addEventListener("click", function(){attachFile()});
    }
    ...
    if (accessAddButton != null) {
        accessAddButton.addEventListener("click", function(){addAccess()});
    }

    if (accessSaveButton != null) {
        accessSaveButton.addEventListener("click", function(){saveAccess()});
    }

    if (accessDeleteButton != null) {
        accessDeleteButton.addEventListener("click", function(){deleteAccess()});
    }
    ...
    blockRefreshModes = ["addInfrastructure", "deleteInfrastructure", "addGroup", "deleteGroup", "addCategory", "deleteCategory", "addAccount", "addAccessLevel", "deleteAccessLevel", "addUser", "deleteUser"];
