...
router.get('/', async function(req, res, next) {
  ...
  res.render('accountInformation', {tabtitle: 'Documentation Software', pagetitle: 'Passwords', search: 'false', topnav: 'none', navSelected: 'passwords', subNavSelected: 'allPasswords', data: pageData});
});
