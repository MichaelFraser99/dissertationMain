...
router.get('/', async function(req, res, next) {
  ...
  res.render('passwords', {tabtitle: 'Documentation Software', pagetitle: 'Passwords', search: 'true', topnav: 'none', navSelected: 'passwords', subNavSelected: 'allPasswords', data: pageData});
});
