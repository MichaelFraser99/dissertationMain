...
router.get('/', async function(req, res, next) {
  ...
  res.render('addAccount', {tabtitle: 'Documentation Software', pagetitle: 'Add Account', search: 'false', topnav: 'none', navSelected: 'passwords', subNavSelected: 'addAccount', data: pageData});
});
